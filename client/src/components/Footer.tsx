      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <div className="space-y-2">
            <h3 className="text-xl">
              <a href="mailto:support@example.com" className="text-primary hover:underline" data-testid="link-email">
                support@example.com
              </a>
            </h3>
            <h2 className="text-2xl font-semibold">
              <a href="tel:+123456789" className="hover:text-primary transition-colors" data-testid="link-phone">
                (+123) 456 789
              </a>
            </h2>
          </div>
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><button onClick={() => scrollToSection('blog')} className="text-muted-foreground hover:text-primary transition-colors" data-testid="footer-link-blog">Blog</button></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <a href="mailto:support@example.com" className="text-muted-foreground hover:text-primary transition-colors" data-testid="footer-email">
                  support@example.com
                </a>
              </div>
              <div className="flex items-start gap-3">
                <Phone size={20} className="text-primary mt-1" />
                <a href="tel:+123456789" className="text-muted-foreground hover:text-primary transition-colors" data-testid="footer-phone">
                  (+123) 456 789
                </a>
              </div>
            </div>
        ...
        <div className="pt-8 border-t border-border text-center">
          <p className="text-muted-foreground text-sm" data-testid="text-copyright">
            © {new Date().getFullYear()} Rankio. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
